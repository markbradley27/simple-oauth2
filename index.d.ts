...
declare module "simple-oauth2" {
  export interface ModuleOptions<ClientIdName extends string = "client_id"> {
    ...
    | {
      ...
      includeClientCredsInTokenRequests?: boolean;
    }
    | undefined;
  }
  ...
  export interface AccessToken {
     ...
     */
    revoke(
      tokenType: { tokenType: TokenType; tokenParamName: string },
      httpOptions?: WreckHttpOptions
    ): Promise<void>;
   ...
   */
  export class ResourceOwnerPassword<
    ClientIdName extends string = "client_id"
  > {
    constructor(options: ModuleOptions<ClientIdName>);
